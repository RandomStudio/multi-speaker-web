...
class MultiChannelPlayer {
  constructor(numSpeakers) {
    this.loadSamples = sources => __awaiter(this, void 0, void 0, function* () {
      ...
      yield Promise.all(requests).then(() => {
...
const createBufferedSamples = (sources, ctx, numSpeakers) => Object.keys(sources).reduce((result, key) => Object.assign(Object.assign({}, result), {
  [key]: {
    src: sources[key],
...
const player = new _dist.default(2);
player.loadSamples({
  jump: "/clips/jump.mp3",
  land: "/clips/land.mp3"
});
